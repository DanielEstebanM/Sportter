...
function PantallaEventos() {
    ...
    const [events, setEvents] = useState({
        ...
        comunidad: [
            ...
            {
                id: 4,
                localTeam: "Los Halcones",
                visitorTeam: "Los Tigres",
                sport: "tenis",
                localImage: "https://i.imgur.com/bUwYQP3.png",
                visitorImage: "https://images2.minutemediacdn.com/image/upload/c_crop,w_3531,h_1986,x_0,y_232/c_fill,w_720,ar_16:9,f_auto,q_auto,g_auto/images/GettyImages/mmsport/90min_es_international_web/01j5c0e6nzzxe7vxjnzk.jpg",
                date: "2023-12-22T16:00:00",
                location: "Club de Tenis",
                isMember: false
            },
            {
                id: 5,
                localTeam: "Las Águilas",
                visitorTeam: "Los Leones",
                sport: "ciclismo",
                localImage: "https://i.imgur.com/bUwYQP3.png",
                visitorImage: "https://i.imgur.com/bUwYQP3.png",
                date: "2023-12-25T10:00:00",
                location: "Circuito Municipal",
                isMember: false
            }
        ]
    });
    ...
    const filteredEvents = searchQuery
        ...
        : [...events[activeTab]].sort((a, b) => new Date(a.date) - new Date(b.date));
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <SportIcon sport={selectedEvent.sport} style={{
                                        width: "20px",
                                        height: "20px",
                                        marginRight: "0.5rem"
                                    }} />
                            ...
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <div style={{
                                        ...
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M19 4H5C3.89 4 3 4.9 3 6V20C3 21.1 3.89 22 5 22H19C20.1 22 21 21.1 21 20V6C21 4.9 20.1 4 19 4ZM19 20H5V10H19V20ZM19 8H5V6H19V8ZM12 13H17V17H12V13Z" fill={primaryColor} />
                                        </svg>
                                    </div>
                                    <div>
                                        <div style={{
                                    ...
                                    <div>
                                        ...
                                        >
                                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginRight: "0.3rem" }}>
                                                <path d="M15 12L8 12V10L15 10V12ZM15 16L8 16V14L15 14V16ZM11 8L11 4L5 4V20H19V8H11ZM9 6H11V8H9V6ZM9 18H7V16H9V18ZM9 14H7V12H9V14ZM9 10H7V8H9V10ZM13 18H11V16H13V18ZM13 14H11V12H13V14ZM13 10H11V8H13V10ZM17 18H15V16H17V18ZM17 14H15V12H17V14ZM17 10H15V8H17V10Z" fill={primaryColor} />
                                            </svg>
                                            Ver en mapa
                                        </motion.button>
                                    </div>
