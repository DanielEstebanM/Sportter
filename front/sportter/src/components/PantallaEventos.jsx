    ...
    const fetchEvents = async () => {
      try {
        ...
        const transformEvent = (evento) => ({
          ...
          localImage:
            evento.equipoLocal?.imagen_url || "https://i.imgur.com/bUwYQP3.png",
          visitorImage:
            evento.equipoVisitante?.imagen_url ||
            "https://i.imgur.com/bUwYQP3.png",
          date: evento.fecha,
          location: evento.ubicacion,
          isMember: evento.esMiembro, // Esto debería venir del backend o calcularse
        });
